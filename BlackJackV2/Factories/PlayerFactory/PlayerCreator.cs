...
namespace BlackJackV2.Factories.PlayerFactory
{
	...
	public abstract class PlayerCreator<TImage, TValue>
	{
		...
		/// </returns>
		public abstract IPlayer<TImage, TValue> CreatePlayer(IBlackJackPlayerHands<TImage, TValue> playerHands, Subject<BetUpdateEvent> betUpdatedSubject, string name);
	}
}
